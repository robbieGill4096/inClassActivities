...
public class MyAvatar extends JPanel
{
	...
	public void paintComponent (Graphics g)
	{
		...
		Color legoYellow = new Color(255,255,0);
		...
		Point value = bob.getBaseMidPoint();
		int grassYOffset = value.y;
		...
		//Robbie's Comment : "Bob's Shirt is now Red because I created an alias named robert and changed the color before draw was called.
